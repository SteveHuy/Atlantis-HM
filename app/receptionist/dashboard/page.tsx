        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="flex items-center p-6">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-semibold text-gray-900">Log Communications</h3>
                <p className="text-sm text-gray-600">Record patient interactions</p>
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="flex items-center p-6">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600">Message providers & staff</p>
